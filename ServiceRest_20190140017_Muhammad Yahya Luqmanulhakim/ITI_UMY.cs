...
namespace ServiceRest_20190140017_Muhammad_Yahya_Luqmanulhakim
{
    ...
    // You can add XSD files into the project. After building the project, you can directly use the data types defined there, with the namespace "ServiceRest_20190140031_Bima_Hayu_Nugraha.ContractType".
    [DataContract]
    public class Mahasiswa
    {
        private string _nama, _nim, _prodi, _angkatan; // _ adalah konvensi atau kesepakatan variabel lokal
        [DataMember(Order = 1)] // Mengitrim data untuk mengurutkan
        public string nama
        {
            get { return _nama; }
            set { _nama = value; }
